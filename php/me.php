...
if (is_file($bootFile)) {
    include_once $bootFile; // NON duplica l'avvio
} else {
    // Fallback inline coerente con l'app sotto /gestione_gare
...
if (session_status() !== PHP_SESSION_ACTIVE) {
    ...
    echo json_encode(['ok'=>false, 'error'=>'Sessione non attiva'], JSON_UNESCAPED_UNICODE);
    exit;
}

if (empty($_SESSION['uid'])) {
    http_response_code(401);
    echo json_encode(['ok'=>false, 'error'=>'Non autenticato'], JSON_UNESCAPED_UNICODE);
    exit;
}
